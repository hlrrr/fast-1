...
@router.post("/signup", status_code=status.HTTP_201_CREATED, response_model=schemas.UserInfo)
...
@router.get("/{id}", status_code=status.HTTP_200_OK, response_model=schemas.UserInfo)
